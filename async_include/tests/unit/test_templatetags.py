...
class TestViews(TestCase):
    ...
    def test_async_include(self, mock_slugify_template_path, mock_get_unique_template_id):
        ...
        self.assertIn(
            '<script id="script_test_template_path__test_uuid" ' 'type="text/javascript">', test_async_include_html
        )
        self.assertIn('make_request__test_template_path__test_uuid', test_async_include_html)
        self.assertIn('const block_id = "test_template_path__test_uuid";', test_async_include_html)
